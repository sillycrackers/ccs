...
extern void DigitalOutputInit(volatile uint32_t portBase, volatile uint8_t pins, volatile uint8_t openDrain);
...
extern uint32_t GPIOReadData(volatile uint32_t PortBase, volatile uint8_t pins);
